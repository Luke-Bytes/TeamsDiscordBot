...
test("E2E happy path: announce -> register -> nominate -> set captains -> random teams -> start -> class bans -> end -> MVP -> winner -> shutdown", async () => {
  ...
  assert(game.getPlayers().length === 10, "10 players should be registered");
