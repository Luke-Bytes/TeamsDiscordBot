...
test("personal season wrapped generates a compact player recap", () => {
  ...
  assert(text.includes("Wrapped Notes"), "Uses wrapped-specific notes field");
  assert(text.includes("Best duo: buddy"), "Includes best duo");
  assert(text.includes("Worst duo: foil"), "Includes worst duo");
